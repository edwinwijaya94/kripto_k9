...
public class NumberFormatter {
	...
	/**
	 * convert binary to int with 2's complement representation
	 * @param s: String of 32 bits length
	 * @return
	 */
	public static int parseBinaryToInt(String s) {
		int i = 0;
